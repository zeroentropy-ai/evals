...
class MasterMtebIngestor(BaseIngestor):
    ...
    def ingest(self) -> tuple[list[Query], list[Document], list[QRel]]:
        ...
        try:
            ...
            if available_splits:
                ...
                raise ValueError(f"No data splits available for {self.task_name}") from None
    ...
    def _combine_all_splits(self, task: Any, available_splits: list[str]) -> tuple[list[Query], list[Document], list[QRel]]:
    ...
    async def load_queries(self) -> list[Query]:
        ...
        try:
            ...
            if available_splits:
                ...
                raise ValueError(f"No query splits available for {self.task_name}") from None
    ...
    async def load_corpus(self) -> list[Document]:
        ...
        try:
            ...
            if available_splits:
                ...
                raise ValueError(f"No corpus splits available for {self.task_name}") from None
    ...
    async def load_qrels(self) -> list[QRel]:
        ...
        try:
            ...
            if available_splits:
                ...
                raise ValueError(f"No qrel splits available for {self.task_name}") from None
