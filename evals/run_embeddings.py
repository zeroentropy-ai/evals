    ...
    with open(dataset.file_path(SAVE_NAME), "w") as f:
        ...
        for query_index, query in enumerate(queries):
            ...
            if INCLUDE_RELEVANT_DOCS:
                ...
                score_lookup = {}
                for idx, score in zip(query_top_sorted_indices, query_similarity_scores, strict=True):
                ...
                sorted_pairs = sorted(zip(final_indices, final_scores, strict=True), key=lambda x: x[1], reverse=True)
